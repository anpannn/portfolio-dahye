package com.dahye.portfolio.admin.context.dashboard.controller

import com.dahye.portfolio.admin.context.dashboard.data.VisitorsDTO
import com.dahye.portfolio.admin.context.dashboard.service.AdminDashboardService
...
class AdminDashboardViewController(private val adminDashboardService: AdminDashboardService
) {
